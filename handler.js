    ...
    try {
      ...
      let isBotAdmin = bot.isAdmin || bot.isSuperAdmin || true // Are you Admin?
        ...
        if (typeof plugin.before == 'function') if (await plugin.before.call(this, m, {
          ...
          if (xp > 200) m.reply('Ngecit ajg') // Hehehe
          else m.exp += xp
...
Terdeteksi @${m.participant.split`@`[0]} telah menghapus pesan , yahaha
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Perintah ini cuman khusus _*OWNER!!*_',
    ...
    unreg: 'Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*${usedPrefix}daftar nama.umur*\n\nContoh: *${usedPrefix}daftar Aupa.17*'
  }[type]
